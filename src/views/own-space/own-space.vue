...
export default {
    ...
    methods: {
        ...
        saveEditPass () {
            this.$refs['editPasswordForm'].validate((valid) => {
                if (valid) {
                    ...
                    // you can write ajax request here
                    this.postRequest("/ownSpace/changePassword",this.editPasswordForm).then(response => {
                      ...
                      if(flag == 1){
                        ...
                        this.$Notice.warning({
                          title : 'Tip',
                          desc : response.data.result.remark
                        })
                      }
                    })
                    this.editPasswordModal = false;
        ...
        saveInfoAjax () {
            ...
            this.postRequest("/ownSpace/editUserInfor", {
              staffname : this.userForm.name,
              telno : this.userForm.cellphone
            }).then(response => {
